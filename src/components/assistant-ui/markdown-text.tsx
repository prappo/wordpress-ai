...
import { ImageSlider } from "@/components/assistant-ui/image-slider";
import { cn } from "@/lib/utils";

const MarkdownTextImpl = (props: { children?: React.ReactNode, text?: string, status?: { type: string } }) => {
  if(props.text === '' && props.status?.type === 'running') {
    return (
      <div>
        <ImageSlider 
          images={[
            '/assets/icons/loading/cook1.png',
            '/assets/icons/loading/cook2.png',
            '/assets/icons/loading/cook3.png',
            '/assets/icons/loading/cook4.png',
            '/assets/icons/loading/cook5.png',
            '/assets/icons/loading/cook6.png',
            '/assets/icons/loading/cook7.png',
          ]}
          className="w-full"
          size={30}
        />
